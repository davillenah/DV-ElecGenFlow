# ESPECIFICACIÓN TÉCNICA: EPIC‑3 — Elecboard IR v1 (Logical Model)
...
## 2. ALCANCE TÉCNICO
Se limita el alcance de la EPIC‑3 exclusivamente a la definición del modelo lógico. Se debe incluir de manera obligatoria:
...
Se prohíbe explícitamente la integración de los siguientes elementos en la EPIC‑3:
...
*   **EPIC-2:** Provee los contratos generales.
*   **EPIC-3:** Define la estructura lógica base.
*   **EPIC-4 y 5:** Enriquecen el IR con componentes y magnitudes.
*   **EPIC-7 y 8+:** Gestionan la traducción a motores de cálculo y optimización.
...
Para la conclusión de la EPIC‑3, se requiere la entrega de:
...
La EPIC‑3 se considerará finalizada únicamente cuando:
