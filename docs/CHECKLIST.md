...
- [x] Network DSL canonical (EPIC‑04.00)
- [x] Registry schema + loader + validation (EPIC‑04.00)
- [x] Adapter DSL→IR (EPIC‑04.00)
- [ ] Load aggregation abajo→arriba (EPIC‑04.01)
- [ ] DAG eléctrico dirigido (EPIC‑04.02)
- [x] JSON bootstrap generator for Registry (EPIC‑04.00) *(snapshot embebido; JSON files versionados llegan en 04.03/04.04)*
...
- [x] Docs base + ADRs actualizados (EPIC‑01.00/03.00)
